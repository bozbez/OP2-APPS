...
#endif
inline void bres_calc_vec( const float x1[][SIMD_VEC], const float x2[][SIMD_VEC], const float q1[][SIMD_VEC], const float adt1[][SIMD_VEC], float res1[][SIMD_VEC], const int bound[][SIMD_VEC], int idx ) {
  float dx, dy, mu, ri, p1, vol1, p2, vol2, f;
...
void op_par_loop_bres_calc(char const *name, op_set set,
  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<(exec_size/SIMD_VEC)*SIMD_VEC; n+=SIMD_VEC ){
      ...
      ALIGNED_float float dat4[4][SIMD_VEC];
